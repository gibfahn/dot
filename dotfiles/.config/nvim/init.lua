...
vim.keymap.set({ "i", "n", "v" }, "<A-1>", function() require("bufferline").go_to(1, true) end, { silent = true, desc = "Go to 1st buffer" })
vim.keymap.set({ "i", "n", "v" }, "<A-2>", function() require("bufferline").go_to(2, true) end, { silent = true, desc = "Go to 2nd buffer" })
vim.keymap.set({ "i", "n", "v" }, "<A-3>", function() require("bufferline").go_to(3, true) end, { silent = true, desc = "Go to 3rd buffer" })
vim.keymap.set({ "i", "n", "v" }, "<A-4>", function() require("bufferline").go_to(4, true) end, { silent = true, desc = "Go to 4th buffer" })
vim.keymap.set({ "i", "n", "v" }, "<A-5>", function() require("bufferline").go_to(5, true) end, { silent = true, desc = "Go to 5th buffer" })
vim.keymap.set({ "i", "n", "v" }, "<A-6>", function() require("bufferline").go_to(6, true) end, { silent = true, desc = "Go to 6th buffer" })
vim.keymap.set({ "i", "n", "v" }, "<A-7>", function() require("bufferline").go_to(7, true) end, { silent = true, desc = "Go to 7th buffer" })
vim.keymap.set({ "i", "n", "v" }, "<A-8>", function() require("bufferline").go_to(8, true) end, { silent = true, desc = "Go to 8th buffer" })
vim.keymap.set({ "i", "n", "v" }, "<A-9>", function() require("bufferline").go_to(-1, true) end, { silent = true, desc = "Go to last buffer" })
