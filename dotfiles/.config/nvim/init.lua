...
vim.keymap.set({ "i", "n", "v" }, "<A-Enter>", vim.lsp.codelens.run, { noremap = false, desc = "CodeLens actions" })
...
vim.keymap.set({ "i", "n", "v" }, "<A-Space>", vim.lsp.buf.code_action, { desc = "Code Action" })
